    ...
    public static void main(String args[])throws IOException
    {
        ...
        case 2: System.out.println("Enter username: ");
                                    ...
                                    while(bo)
                {
                    ...
                    {
                        case "M":case "m":
                        System.out.println("1-View Medical stock \n 2-Print file and exit\n");
                        a2=scan.nextInt();
                        switch(a2)
                        {
                        case 1:
                    ...
                    break;
                    case "S":case "s":
                    System.out.println("1-View surgical stock \n 2-Print file and exit\n");
                    a2=scan.nextInt();
                    switch(a2)
                    {
                        case 1:
